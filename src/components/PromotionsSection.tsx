  ...
  const promos = [
    {
      ...
      title: 'LIVE RADIO SENSITIZATION PROGRAMS',
      description: 'In these programs we aim to Sensitize farmers on proper coffee handling (post harvest handling ,transportation) so that they can earn more income from there harvests. TUNE IN ',
      offerValue: '100% RECOMMENDED',
      validUntil: 'Sartuday & Tuesday',
      cta: 'Register for weekly reminders about this event via Whatsapp',
      icon: Percent,
