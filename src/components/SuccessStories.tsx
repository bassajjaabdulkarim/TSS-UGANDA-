...
export default function SuccessStories() {
  ...
  const getStoryImageFallback = (key: 'coffee' | 'factory' | 'truck') => {
    if (key === 'truck') return "/src/assets/images/yellow_tarp_truck_1780390607794.png";
    if (key === 'coffee') return "/src/assets/images/orange_tarp_coffee_1780390624788.png";
    return "/src/assets/images/tarpaulin_customization_hub_1780388737537.png";
  };
